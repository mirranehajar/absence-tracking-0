...
export class EnseignantService {
  ...
  public async update() {
    await this.http.post<Enseignant>(this._url + 'update', this.enseignantFounded).toPromise().then(
      (data) => {
        if (data) {
  ...
  public async save() {
    ...
    await this.http.post<Enseignant>(this._url, this.enseignant).toPromise().then(
        (data) => {
          if (data) {
            this.enseignants.push(this.clone(data));
